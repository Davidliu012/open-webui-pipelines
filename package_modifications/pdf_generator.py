# """
#     Modified from `backend/open_webui/utils/pdf_generator.py` in the docker container.
#     The modification is based on the reported issue -- https://github.com/open-webui/open-webui/discussions/11840.
    
#     *** Remember to `pip install mistletoe` manually if you are using the `pip install` method. ***
# """ 
